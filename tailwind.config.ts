...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        "card":    "0 0 0 1px rgba(16,24,40,0.05), 0 4px 16px rgba(16,24,40,0.06)",
        "card-lg": "0 0 0 1px rgba(16,24,40,0.06), 0 12px 32px rgba(16,24,40,0.10)",
        "float":   "0 0 0 1px rgba(16,24,40,0.06), 0 20px 40px rgba(16,24,40,0.12)",
        "accent":  "0 0 0 3px rgba(230,10,28,0.20)",
        "inset-petrol": "inset 0 1px 3px rgba(16,24,40,0.08)",
        "netto":   "0 0 25px rgba(14,159,110,0.18)",
        "glow-accent": "0 8px 30px rgba(230,10,28,0.28)",
        "glow-petrol": "0 8px 30px rgba(16,24,40,0.10)",
      },
      borderRadius: {
        "2xl": "16px",
        "3xl": "24px",
