...
import { Calculator, ArrowLeft, BookOpen, HelpCircle } from "lucide-react";
...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-black text-white flex flex-col justify-between font-sans selection:bg-[#E60A1C] selection:text-white relative overflow-hidden">
      <SiteHeader />
