    ...
    <section className="w-full max-w-6xl mx-auto px-5 pt-20 pb-16 min-h-[80vh]">
      ...
      <div className="w-full max-w-6xl mx-auto bg-[#0A0A0A] border border-white/10 rounded-3xl p-8 sm:p-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-sm sm:text-base">
          <div>
            <h3 className="font-bold text-white text-base sm:text-lg mb-2">Wie funktioniert der Netto Brutto Rechner 2027?</h3>
            <p className="text-white/70 leading-relaxed">
              Sie können im Rechner sowohl die normale Brutto-zu-Netto-Rechnung als auch die umgekehrte Netto-zu-Brutto-Kalkulation nutzen. Schalten Sie einfach auf das Steuerjahr 2027, um Ihre finanzielle Planung frühzeitig auf die geplante Tarifreform abzustimmen.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-white text-base sm:text-lg mb-2">Was ändert sich beim Lohnrechner 2027 gegenüber 2026?</h3>
            <p className="text-white/70 leading-relaxed">
              Hauptziel der Reform 2027 ist der Ausgleich der kalten Progression durch höhere Grund- und Kinderfreibeträge. Für Arbeitnehmer bedeutet das: Von Ihrem Bruttogehalt verbleibt ab Januar 2027 spürbar mehr <strong className="text-white">Netto 2027</strong> auf dem Konto.
            </p>
          </div>
        </div>
      </div>
